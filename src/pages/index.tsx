...
const ACTIONS: Array<NavigationItem> = [
	...
	},
	{
		type: NavigationItemType.LINK,
		external: true,
		href: 'https://github.com/handokota',
			...
			<div className="min-h-screen flex items-center justify-center py-12">
				<div className="max-w-md sm:max-w-lg md:sm:max-w-3xl lg:sm:max-w-6xl w-full space-y-8 text-center">
					<Animate
						...
						className="text-gray-500 dark:text-white text-2xl sm:text-4xl md:text-6xl lg:text-8xl tracking-tight font-extrabold">
						Hey <span className="inline-block origin-70 hover:(animate-wave)">👋</span>{' '}
						I&apos;m Handoko, <br />a{' '}
						<Pill.Standard className="mt-4">system administrator</Pill.Standard>
					</Animate>
